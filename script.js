function sendMoney(){
    ...
    if (enterAmount > enterSAmount){
        ...
        var textNode = document.createTextNode(`₹ ${enterAmount} is sent from the sender with email-id ${enterSName}@gmail.com to recipient with email-id ${enterName}@gmail.com on ${Date()}.`);
